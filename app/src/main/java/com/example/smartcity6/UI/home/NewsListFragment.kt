...
class NewsListFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        ServiceCreate.smartCityCrete.getNewsList(null,param1.toString()).enqueue(object :Callback<NewsList>{
            ...
            override fun onResponse(p0: Call<NewsList>, p1: Response<NewsList>) {
               val boyd= p1.body()
                if (boyd != null){
                    val adapter = ItemAdapter(R.layout.item_news,boyd.rows,CC::class.java)
